...
class MeetingAgentTest {
     ...
     * checkpoint emits [m:ss] on every bullet and that is the point of it. Provenance tags ([cN],
     * which name a CHUNK index) stay internal: they mean nothing to a reader.
     */
