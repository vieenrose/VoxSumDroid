...
class LitePod private constructor(
    ...
    companion object {
        ...
        // Desktop build: the .so is loaded once, by absolute path, in
        // studio.voxsum.desktop.NativeLibs.ensureLoaded() (java.library.path is not
        // usable there — see the comment in that file). Once in the process its
        // symbols resolve for every JNI caller, so this is a no-op guard, matching
        // how the vendored sherpa wrappers were adapted.
