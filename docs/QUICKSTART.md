...
| **Open session (.ogg)** | Reopen a session you saved earlier and keep editing. |
...
<p align="center"><img src="screenshots/02-add-source.png" width="240" alt="Add audio sheet"></p>
...
<p align="center">
  <img src="screenshots/03-transcript.png" width="240" alt="Transcript with speakers and player">
  &nbsp;
  <img src="screenshots/04-summary.png" width="240" alt="Summary">
</p>

- **Who spoke when** — each line is tagged and colour-coded by speaker. VoxSum can **guess speakers'
  real names** from what they say (top-bar ↻ menu → *Detect names*).
...
- **Summary, your way** — a short title and a summary as **bullets, an executive brief, or a
  narrative** (pick the style in **Settings**), in the language you choose.
